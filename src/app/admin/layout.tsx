...
export default function AdminLayout({
  ...
  const isFullWidth = pathname === "/admin" || pathname.startsWith("/admin/crm") || pathname.startsWith("/admin/analytics") || pathname.startsWith("/admin/sellers-management") || pathname.startsWith("/admin/inventory") || pathname.startsWith("/admin/photo-editor") || pathname.startsWith("/admin/deals") || pathname.startsWith("/admin/payouts") || pathname.startsWith("/admin/compliance") || pathname.startsWith("/admin/finance") || pathname.startsWith("/admin/staff") || pathname.startsWith("/admin/settings");
