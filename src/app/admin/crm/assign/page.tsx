...
// Lead assignment (manager) — bulk assign by region, vehicle make, Scout score

import { CrmTopbar } from "@/components/admin/crm-topbar";

export default function CrmAssignPage() {
  return (
    <div className="flex flex-col h-full" style={{ background: "#0B111E" }}>
      <CrmTopbar title="Assignment" />
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <h2
            ...
            style={{ color: "#F1F5F9" }}
          >
            No leads to assign yet
          </h2>
          <p
            className="mt-2 text-sm leading-relaxed"
            style={{ color: "#6B7A90", fontFamily: "var(--font-body)" }}
          >
            Bulk-assign leads to reps by region, vehicle make, or Scout score.
            Once leads start arriving they will appear here ready to route.
          </p>
        </div>
      </div>
    </div>
